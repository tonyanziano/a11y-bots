...
const adapter = new BotFrameworkAdapter({
  appId: process.env.msaAppId,
  appPassword: process.env.msaAppPw
});

let credentials;
if (process.env.msaAppId && process.env.msaAppPw) {
  console.log(`Initializing with appId: ${process.env.msaAppId} & appPw: ${process.env.msaAppPw}`)
  credentials = new MicrosoftAppCredentials(process.env.msaAppId, process.env.msaAppPw);
}
